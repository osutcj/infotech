...
export default function Hero({ dictionary }: HeroProps) {
  ...
  const nextEventDate = new Date("2026-04-14T19:00:00").getTime();
  ...
  return (
    ...
    >
      <div className="relative max-w-6xl w-full px-2">
        ...
        <div className="relative w-full h-137.5 md:h-175 rounded-3xl overflow-hidden border border-white/20 ">
          <Image
          ...
          <div className="absolute md:top-6 md:right-6 top-2 right-2 flex gap-2 flex-col items-end">
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 border border-white/20 min-w-50">
